...
Revisão documental: 2 de agosto de 2026. Referência: firmware v071 e aplicativo v041.
...
1. Executar uma regressão completa do App v041 + Firmware v071 em uma CYD real: instalar e apagar vários áudios, instalar faces, reiniciar, validar menus, tocar áudio, alternar faces e atualizar firmware.
