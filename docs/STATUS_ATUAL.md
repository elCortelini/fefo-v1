...
Revisão documental: 16 de agosto de 2026. Referência: firmware v076 e aplicativo v065.
...
1. Executar uma regressão completa do App v065 + Firmware v076 em uma CYD real: instalar e apagar vários áudios, reinstalar pelo catálogo, instalar faces, reiniciar, validar menus, tocar áudio, alternar faces e atualizar firmware/app.
