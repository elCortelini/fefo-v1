# 🤖 FEFO IA - Criador de Ninar

Esta área está integrada ao site do FEFO e reúne o player relaxante, os recursos de áudio e as ferramentas de geração de música terapêutica.

Abra pelo site em [Criador de Ninar](index.html) ou diretamente em `criador-de-ninar/index.html`.
