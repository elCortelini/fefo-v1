...
|---|---:|---|
| Firmware CYD | `0.0.75` / BLE `FEFO_BLE_V075` | `releases/FEFO_Firmware_v075.bin` |
| Aplicativo Android | `1.0.64+64` (App v064 `com.elcortelini.fefo.app`) | `releases/FEFO_App_v064.apk` |
