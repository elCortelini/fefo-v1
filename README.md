...
|---|---:|---|
| Firmware CYD | `0.0.76` / BLE `FEFO_BLE_V076` | `releases/FEFO_Firmware_v076.bin` |
| Aplicativo Android | `1.0.65+65` (App v065 `com.elcortelini.fefo.app`) | `releases/FEFO_App_v065.apk` |
