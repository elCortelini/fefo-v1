    ...
    return PaginaBase(
      ...
      child: Column(
        children: [
          ...
          Text('Vibrações do FEFO',
              style: TextStyle(
                  fontFamily: 'Billotilde',
                  fontSize: 42,
                  color: Theme.of(context).colorScheme.secondary)),
          const Text('Todos os padrões são intensos e duram 7 segundos.',
              style: TextStyle(fontFamily: 'KGPen', fontSize: 15)),
          ...
          Expanded(
            child: GridView.builder(
              ...
              itemBuilder: (context, index) => ElevatedButton.icon(
                ...
                label: Text('${index + 1}. ${_nomes[index]}',
